app.controller('HomeController', ['$scope', function($scope) {
	...
	*/
	...
	/* ADD NEW MOVIES */
      ...
      country:    'USA',
      posters:    ['img/twelve_angry_men.jpg','img/twelve_angry_men2.jpg'],
      imdb:       'https://www.imdb.com/title/tt0050083',
      website:    'https://en.wikipedia.org/wiki/12_Angry_Men_(1957_film)',
      likes:      855,
      dislikes:   99,
      posterindex: 0
      },
    { 
      ...
      rating:     'PG-13',
      runtime:    201,
      released:   new Date('2004', '03', '12'),
      country:    'USA',
      posters:    ['img/lordofthering.jpg','img/lordofthering2.jpg'],
      imdb:       'https://www.imdb.com/title/tt0167260',
      website:    'https://www.amazon.com/Lord-Rings-Return-King/dp/B0037WTD5G',
      likes:      828,
      dislikes:   127,
      posterindex: 0
      },
    { 
      ...
      released:   new Date('1994', '10', '14'),
      country:    'USA',
      posters:    ['img/pulpfiction.jpg','img/pulpfiction2.jpg'],
	...
	$scope.title="IMDB + Jimmy's Top 8 Movies";
      $scope.owner="Jimmy She";
      $scope.github="http://www.github.com/jxs4";
